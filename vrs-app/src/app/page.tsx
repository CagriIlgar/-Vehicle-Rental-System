            ...
            >
                ...
                <div className="things-grid">
                    <div className="things-card">
                        ...
                        <h3><span className="things-link">RELAX ON THE BEACH:</span> Cyprus is well known for its beautiful sandy beaches and the crystal clear waters. You can find a wealth of beaches and the one you desire.</h3>
                    </div>
                    <div className="things-card">
                        <img src="/places.jpg" alt="Places to Visit" />
                        <h3><span className="things-link">PLACES TO VISIT:</span> Rent a car in Cyprus with us and get ready to discover an island of compelling culture and landscapes, steeped in myth and riddled with ancient riches.</h3>
                    </div>
                    <div className="things-card">
                        <img src="/nightlife.jpg" alt="Nightlife" />
                        <h3><span className="things-link">CYPRUS NIGHTLIFE:</span> Whatever you opt for, Cyprus has it. A huge range of stylish cafes and bars, pubs, chic lounges, jet set beach clubs, music bars or dance clubs.</h3>
                    </div>
                    <div className="things-card">
                        <img src="/cuisine.jpg" alt="Cuisine" />
                        <h3><span className="things-link">CYPRUS CUISINE:</span> Your holidays in Cyprus will not be complete without tasting some traditional Cypriot dishes and delicacies.</h3>
                    </div>
                </div>
            </section>
            </div>
